...
}, 'App\\Form\\Contrebandier1Type' => function () {
    return ($this->privates['App\Form\Contrebandier1Type'] ?? $this->privates['App\Form\Contrebandier1Type'] = new \App\Form\Contrebandier1Type());
}, 'App\\Form\\ContrebandierType' => function () {
    return ($this->privates['App\Form\ContrebandierType'] ?? $this->privates['App\Form\ContrebandierType'] = new \App\Form\ContrebandierType());
}, 'App\\Form\\Produits1Type' => function () {
    return ($this->privates['App\Form\Produits1Type'] ?? $this->privates['App\Form\Produits1Type'] = new \App\Form\Produits1Type());
}, 'App\\Form\\ProduitsType' => function () {
    return ($this->privates['App\Form\ProduitsType'] ?? $this->privates['App\Form\ProduitsType'] = new \App\Form\ProduitsType());
